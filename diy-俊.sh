...
cp $CURRENT_DIR/JMK/VideoView.java $CURRENT_DIR/$DIR/player/src/main/java/xyz/doikki/videoplayer/player/VideoView.java
...
sed -i 's/ts_40/ts_50/g' $CURRENT_DIR/$DIR/app/src/main/res/layout/player_vod_control_view.xml
...
sed -i 's/播放器/内置播放/' $CURRENT_DIR/$DIR/app/src/main/res/layout/fragment_model.xml
